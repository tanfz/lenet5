...
architecture behav of conv_top is 
    ...
    "conv_top,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=2927174,HLS_SYN_TPT=none,HLS_SYN_MEM=60,HLS_SYN_DSP=14,HLS_SYN_FF=15600,HLS_SYN_LUT=17307,HLS_VERSION=2018_3}";
