...
// ==============================================================
#ifndef __conv_top_fcmp_32ndEe__HH__
#define __conv_top_fcmp_32ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv_top_fcmp_32ndEe) {
    ...
    SC_CTOR(conv_top_fcmp_32ndEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
